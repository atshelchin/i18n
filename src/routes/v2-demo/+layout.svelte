<script lang="ts">
	...
	import { initI18n, setI18nContext, registerGlobLoaders } from '$lib/v2/index.js';
	...
	i18n.setLocale = async (locale: string) => {
		...
		const newPath = `/${locale}${pathWithoutLocale || '/v2-demo'}`;
		await goto(newPath);
	};
</script>
...
<div class="demo-container">
	<header class="demo-header">
		...
		<!-- <p class="subtitle">{i18n.t('home.description')}</p> -->
	</header>
	{@render children()}
</div>
